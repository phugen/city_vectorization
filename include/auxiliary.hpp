...
void clusterCells (int totalNumberCells, float rhoStep, int numRho, int numAngle, cv::Vec3f primaryCellPos, std::vector<cv::Vec3f>* cellPos);
...
double distanceFromPolarLine (cv::Vec2f point, cv::Vec3f polarLine, cv::Mat* image);
